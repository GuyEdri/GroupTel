<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="joinGroup1.aspx.cs" Inherits="GroupTelFV.joinGroup1" Async="true" %>
...
<head runat="server">
    ...
    <link href="CSS/JoinGroup.css?v6" rel="stylesheet" />
<%--    <link href="CSS/Query-size.css" rel="stylesheet" />--%>
    ...
    <script> 
        ...
        //create a timer for the product that counts down until group is closed
