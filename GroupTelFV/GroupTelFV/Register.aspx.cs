...
namespace GroupTelFV
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        {
            int countMail = 0;
            //create a list of users already existing
            ...
            for(int y=0; y<count; y++)
            {
                ...
                else if(y == count -1)
                {
                    ...
                    /*create a user in the user table (T_users) after registration and send mail confirmation to user after registration 
                     with relevant information about user*/
