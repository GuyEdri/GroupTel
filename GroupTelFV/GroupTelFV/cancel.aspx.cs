    ...
    public partial class cancel : System.Web.UI.Page
    {
        ...
        {   /*checking if the input of the password of the customer matches the DB */
            if (cancel1.Text == (string)Session["UserPass"])
            {
                ...
                if((int)Session["pquantity2"] == 1 || (int)Session["pquantity2"] == 2 )
                {
                ...
                if((int)Session["pquantity2"] == 0)
                {
                    ...
                    /*for mail NEW END*/
                    string scriptText = "alert('הזמנה בוטלה בהצלחה,מייל ביטול יישלח אליכם בהקדם'); window.location='" + Request.ApplicationPath + "profile.aspx'";
