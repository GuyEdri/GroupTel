...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="categories">
        <div class="category">
            <!-- create a list of buttons with sub-categories for easier navigation -->
    ...
    <!-- create a display of all relevant products to the category the user chose in the default page -->
